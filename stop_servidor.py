...
def callback_partidas(mqttc, userdata, msg):
    ...
    """
    spl=msg.topic.split("/") #['clients','stop','partidas','1','puntos']
    ...
    if (msg.payload==b"READY_YES") and (userdata[indice_partida]['info']['estado']==1):
        ...
        try:
            ...
            userdata[indice_partida]['info']['alfabeto']=alfabeto
            letra=(userdata[indice_partida]['info']['alfabeto']).pop(0)
    ...
    #
        ...
        #
        if spl[4]!="puntos" and spl[4]!="votacion": #['clients','stop','partidas','1','jugador']
            ...
            if (cuantos == userdata[indice_partida]['info']['confirmados']):
                ...
                if cuantos>1:
                    ...
                    mqttc.publish(choques+"/jugadores/"+lista_usuarios[0],
                                      payload="JUGADORES_INSUFICIENTES")
            ##
        elif spl[4]=="votacion": #['clients','stop','partidas','1','votacion']
            ...
            ##
        elif spl[4]=="puntos": #['clients','stop','partidas','1','puntos']
...
def callback_jugadores(mqttc, userdata, msg):
    ...
    del servidor.
    """
    spl=msg.topic.split("/") #['clients','stop','jugadores','nombre']
...
def callback_solicitudes(mqttc, userdata, msg):
    ...
    spl=msg.topic.split("/") #['clients','stop','solicitudes','jugador']
    if len(spl)==3: #['clients','stop','solicitudes']
    ...
    if len(spl)==4: #['clients','stop','solicitudes','jugador']
        usuario=spl[3]
        if msg.payload==b"0":
...
def callback_servidor(mqttc, userdata, msg):
    ...
    spl=msg.topic.split("/") #['clients','stop','servidor','nombre']
